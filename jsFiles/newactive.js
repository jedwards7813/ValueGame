...
var activeGame = (function() {
    ...
    var compAns1,
        ...
        pages = {
            r1: {
                ...
                <p>The goal of the <span class='${text.span1}'>${text.game1}</span> is to turn on as many lightbulbs on in a row as possible.</p>
                ADD NEW INSTRUCTIONS ABOUT PAYMENT STRUCTURE
                ...
                <p>You will also have a counter at the top of your screen to keep track of the length of your current streak</p>
                </div>`,
                ...
                `<div class='parent'>
                <p>If you turn on a lightbulb, you'll see this image...</p>
                <img src='img/lightbulbOn.png', style='height: 75%'>
                </div>`,

                `<div class='parent'>
                <p>...and if you don't turn on a lightbulb, you'll see this image.</p>
            ...
            r2: {
                ...
                <span class='${text.span2}'>${text.color2}</span>, your odds of turning on the lightbulb that trial 
                ...
                <br>your odds of turning on the lightbulb that trial are <span class='${text.span2}'>${text.worstOdds2}</span>
    ...
    */
    ...
    function MakeFeedback(round) {
        ...
        console.log (img) 
        if (img == "<img src='img/lightbulbOff.png' class='rewardimg'>") {
            Streak = 0
            }
        else if (img == "<img src='img/lightbulbOn.png' class='rewardimg'>") {
            Streak = Streak + 1
        };
        if (img == "<img src='img/lightbulbOff.png' class='rewardimg'>") {
            lightbulbPic = "<img src='img/lightbulbOff.png' class='rewardimg'>"
            }
        else if (img == "<img src='img/lightbulbOn.png' class='rewardimg'>") {
            lightbulbPic = "<img src='img/lightbulbOn.png' class='rewardimg'>"
        };
        this.stimulus = function(){
            return `<div style='font-size: 80px'><p>Current Streak:</p><p>${Streak}</p><p>${lightbulbPic}</p></div>;`
        };
        this.on_finish = function(data){
            if (tNum == 10) {
                tNum = 0;
            ...
            data.img == "<img src='img/lightbulbOn.png' class='rewardimg'>" ? data.Jackpot = true : data.Jackpot = false;
    ...
    var probeR1 = new MakeProbe('R1'),
        ...
        DisplayStreakR1 = new DisplayStreak('R1'),
        DisplayStreakR2 = new DisplayStreak('R2')

    p.task.round1 = {
        timeline: [delayR1, tooFastR1, probeR1, responseR1, feedbackR1, DisplayStreakR1],
        repetitions: 50,
    };

    p.task.round2 = {
        timeline: [delayR2, tooFastR2, probeR2, responseR2, feedbackR2, DisplayStreakR2],
        repetitions: 50,
    };
