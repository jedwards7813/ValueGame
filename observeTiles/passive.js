...
var passiveGame = (function() {
    ...
    jsPsych.data.addProperties({
        pM_Passive: settings.pM,
        pEM_Passive: settings.pEM,
        colorOrder_Passive: settings.colorOrder,
    });
    ...
    */
    ...
    function MakeTooFast(round) {
        ...
        this.stimulus = function() {
            var message = `<div style='font-size: 20px'><p>Too Fast!</p><p>Please wait for the trial to end 
    ...
    p.task.round1 = {
        timeline: [delayR1, tooFastR1, probeR1, tooFastR1, responseR1, tooFastR1, feedbackR1],
        repetitions: 50,
    };

    p.task.round2 = {
        timeline: [delayR2, tooFastR2, probeR2, tooFastR2, responseR2, tooFastR2, feedbackR2],
        repetitions: 50,
    };
