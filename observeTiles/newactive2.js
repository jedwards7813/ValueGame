    ...
    var compAns1,
        ...
        pages = {
            r1: {
                ...
                `<div class='parent'>
                <p>At the end of the study, you will receive $1.50 for your participation, plus an additional ${text.value} cent${text.plural} for each success you achieve.</p>
                </div>`,
            ...
            r2: {
                ...
                <span class='${text.span1}'>${text.game1}</span> with one exception.</p>
                </div>`,
    ...
    */
    ...
    function MakeFeedback(round) {
        ...
        this.stimulus = function(){ 
            ...
            if (img == "failure") {
            length = streak, streakEarnings = length*10, streak = 0
            }
            else if (img == "success") {
            streak = streak + 1
            };
            ...
            return `<div style='font-size: 50px'><p>Current Streak:</p><p>${streak}</p><p>${summary}</p></div>`
            };
        this.on_finish = function(data){
            if (tNum == 10) {
                tNum = 0;
