...
var valueGame = (function() {
    ...
    if (settings.noJackpot == 0) {
        text.compChkVal = '', compChk3Ans = "0" 
    }
    else if (settings.val == 2) {
        text.compChkVal = '1-cent ', compChk3Ans = "1 Cent"
    }
    else {text.compChkVal = '10-cent ', compChk3Ans = "1"};

    var stim = {
        r1: {
            m1: `<div class="box" style="background-color:${text.hex1}"> </div>`,
            m0: `<div class="box" style="background-color:white"> </div>`,
            e1: `<img src='img/lightbulbOn.png' class='rewardimg'>`,
            e0: `<img src='img/lightbulbOff.png' class='rewardimg'>`
        },
        r2: {
    ...
    if (settings.noJackpot == 0) {
        pages = {
            r1: {
                ...
                <p>The goal of the <span class='${text.span1}'>${text.game1}</span> is to turn on as many lightbulbs as possible. 
                Jackpots are not worth any money</p>
                <p>At the end of the study, you will receive $1.50 for your participation</p>
                </div>`,

                `<div class='parent'>
                <p>To win Jackpots, you will try to "activate" tiles like this one:</p>
                ...
                `<div class='parent'>
                <p>If you turn a tile <span class='${text.span1}'>${text.color1}</span>, your odds of winning a 
                ...
                your odds of winning a Jackpot that trial are <span class='${text.span1}'>${text.worstOdds1}</span>.</p>
                </div>`,

                `<div class='parent'>
                <p>If you win a Jackpot, you'll see this image...</p>
                <img src='img/lightbulbOn.png', style='height: 75%'>
                </div>`,

                `<div class='parent'>
                <p>...and if you don't win a Jackpot, you'll see this image.</p>
                <img src='img/lightbulbOff.png', style='height: 75%'>
                </div>`],
            ...
            r2: {
                ...
                <span class='${text.span2}'>${text.color2}</span>, your odds of winning a Jackpot that trial 
                ...
                <br>your odds of winning a Jackpot that trial are <span class='${text.span2}'>${text.worstOdds2}</span>
    ...
    var compAns1,
        ...
        pages = {
            r1: {
                ...
                part2: [`<div class='parent'>
                <p>The goal of the <span class='${text.span1}'>${text.game1}</span> is to turn on as many lightbulbs as possible.</p>
                <p>For every lightbulb you turn on, you will receive an extra ${text.value} cent${text.plural}; at the end of the study, 
                you will receive $1.50 for your participation, plus an additional ${text.value} cent${text.plural} for each lightbulb you turn on.</p>
                </div>`,

                `<div class='parent'>
                <p>To turn on lightbulbs, you will try to "activate" tiles like this one:</p>
                <div class="box" style="background-color:gray"></div>
                </div>`,
                ...
                `<div class='parent'>
                <p>If you turn a tile <span class='${text.span1}'>${text.color1}</span>, your odds of turning on the lightbulb that trial are <span class='${text.span1}'>${text.bestOdds1}</span>.</p>
                <div class='box' style='background-color:${text.hex1}'></div>
                </div>`,

                `<div class='parent'>
                <p>If a tile disappears before you turn it <span class='${text.span1}'>${text.color1}</span>,
                your odds of turning on the lightbulb that trial are <span class='${text.span1}'>${text.worstOdds1}</span>.</p>
                </div>`,

                `<div class='parent'>
                <p>If you turn on the lightbulb, you'll see this image...</p>
                <img src='img/lightbulbOn.png', style='height: 75%'>
                </div>`,

                `<div class='parent'>
                <p>...and if you don't turn on the lightbulb, you'll see this image.</p>
                <img src='img/lightbulbOff.png', style='height: 75%'>
                </div>`],
            ...
            r2: {
                ...
                `<div class='parent'>
                <p>Second, in the <span class='${text.span2}'>${text.game2}</span>, if you turn a tile 
                <span class='${text.span2}'>${text.color2}</span>, your odds of turning on the that trial 
                are <span class='${text.span2}'>${text.bestOdds2}</span> (instead of <span class='${text.span1}'>${text.bestOdds1}</span>)...</p>
                <div class='box' style='background-color:${text.hex2}'></div>
                </div>`,
                ...
                `<div class='parent'>
                <p>...and if a tile disappears before you turn it <span class='${text.span2}'>${text.color2}</span>,
                <br>your odds of winning a ${text.value}-cent Jackpot that trial are <span class='${text.span2}'>${text.worstOdds2}</span>
                (instead of <span class='${text.span1}'>${text.worstOdds1}</span>).</p>
                </div>`,
    ...
    function MakeLoop(span, game, color, round) {
        ...
        var compChk1 = {
            ...
            questions: [
                ...
                what are your chances of turning on a lightbulb on that trial?`,
        ...
        var compChk3 = {
            ...
            please answer the following question.</p></div>`,
            questions: [
                {prompt: `If you turn on a lightbulb on a given trial, how much money will you earn?`,
                name: `valueChk_${round}`,
                labels: [
                "0 Cents",
                "10 Cents"]}
                ],
            scale_width: 500,
            on_finish: function(data){
                compAns3 = JSON.parse(data.responses)[`valueChk_${round}`]
            },
        };
        ...
        var conditionalNode = {
            ...
            conditional_function: function() {
                var i = (round == 'R1') ? 0 : 1;
                return (compAns1 == settings.pEM[i] && compAns2 == (10-settings.pEM[i]) && compAns3 == compChk3Ans) ? false : true;
            }
        };
        if (round == 'R1'){ 
        this.timeline = [info, compChk1, compChk2, compChk3, conditionalNode]}
        else {this.timeline = [info, compChk1, compChk2, conditionalNode]};
    ...
    */
    ...
    function MakeFeedback(round) {
        ...
        this.on_finish = function(data){
            ...
            data.stimulus == "<img src='img/lightbulbOn.png' class='rewardimg'>" ? data.Jackpot = true : data.Jackpot = false;
        };
